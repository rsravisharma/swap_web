...
class PdfBookSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ✅ FIRST: Create/Ensure Categories Exist
        $this->seedCategories();
        ...
        // Get category IDs
        $categoryIds = PdfCategory::pluck('id')->toArray();

        // Sample Google Drive file IDs
        $sampleDriveFiles = [
            ['file_id' => '1u8emOvAYI85JQg184K0RU_IYh6jmdO6T', 'shareable_link' => 'https://drive.google.com/file/d/1u8emOvAYI85JQg184K0RU_IYh6jmdO6T/view?usp=sharing'],
            ['file_id' => '1SImIS8yPmjZOtQiLAYlkrO0v-UBtfqNX', 'shareable_link' => 'https://drive.google.com/file/d/1SImIS8yPmjZOtQiLAYlkrO0v-UBtfqNX/view?usp=sharing'],
            ['file_id' => '1MzDVOIVQsRueSubr78Z4zuu7f0Wsvw6G', 'shareable_link' => 'https://drive.google.com/file/d/1MzDVOIVQsRueSubr78Z4zuu7f0Wsvw6G/view?usp=sharing'],
            ['file_id' => '12P4o1zncd2FmCUDZrrYhqlE1gW7pYVgM', 'shareable_link' => 'https://drive.google.com/file/d/12P4o1zncd2FmCUDZrrYhqlE1gW7pYVgM/view?usp=sharing'],
            ['file_id' => '1_WXJsOav47AqT8TyUPsXSFY2Tt6iZlsP', 'shareable_link' => 'https://drive.google.com/file/d/1_WXJsOav47AqT8TyUPsXSFY2Tt6iZlsP/view?usp=sharing'],
        ];

        // Updated book templates WITH category assignments
        $bookTemplates = [
            [
            ...
            [
                ...
                'file_size' => 593920,
                'seller_id' => 1,
                'category_id' => 7, // ✅ Romance (Fiction > Novels > Romance)
        ...
        foreach ($bookTemplates as $index => $template) {
            ...
            PdfBook::create([
                ...
                'category_id'           => $template['category_id'], // ✅ Added!
                'isbn'                  => $template['isbn'],
        ...
        $this->command->info('PDF Books seeded successfully with categories!');
    }

    /**
     * ✅ Helper method to seed categories first
     */
    private function seedCategories(): void
    {
        ...
        $novels = PdfCategory::where('slug', 'novels')->first();
        PdfCategory::firstOrCreate(
            ['slug' => 'romance', 'parent_id' => $novels->id],
            ['name' => 'Romance', 'level' => 3, 'parent_id' => $novels->id]
        );

        $this->command->info('Categories seeded/verified successfully!');
    }
}
