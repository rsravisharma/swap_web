...
class LocationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // --- Generic types ---
        $genericLocations = [
            ['type' => 'current', 'name' => 'Use Current Location', 'country_id' => $countryIdIndia, 'created_at' => $now, 'updated_at' => $now],
            ['type' => 'custom', 'name' => 'Custom Location', 'country_id' => $countryIdIndia, 'created_at' => $now, 'updated_at' => $now],
            ['type' => 'online', 'name' => 'Online (Digital Items)', 'country_id' => $countryIdIndia, 'created_at' => $now, 'updated_at' => $now],
            ['type' => 'shipping', 'name' => 'Shipping (Deliverable)', 'country_id' => $countryIdIndia, 'created_at' => $now, 'updated_at' => $now],
            ['type' => 'campus', 'name' => 'Campus', 'country_id' => $countryIdIndia, 'created_at' => $now, 'updated_at' => $now],
        ];

        DB::table('locations')->insert($genericLocations);
        ...
        foreach ($cities as $city) {
            ...
            $cityIds[$city['name']] = $cityId; // store city_id for universities
        }

        // --- Universities linked to city_id ---
        $universities = [
...
['name'=>'Government Post Graduate College', 'city'=>'Una', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.govtpgcollegeuna.in', 'logo' => null, 'established_year'=> 1968, 'ranking' => null ],
...
['name'=>'All India Institute of Medical Sciences (AIIMS)', 'city'=>'Bilaspur', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.aiimsbilaspur.edu.in', 'logo' => 'https://www.aiimsbilaspur.edu.in/Content/images/logo.png', 'established_year'=> 2017, 'ranking' => null ],
['name'=>'Government Post Graduate College', 'city'=>'Bilaspur', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gcbilaspur.in', 'logo' => 'https://gcbilaspur.in/wp-content/themes/college/images/logo.png', 'established_year'=> 1952, 'ranking' => null ],
...
['name'=>'Government Polytechnic College', 'city'=>'Hamirpur', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gph.edu.in', 'logo' => null, 'established_year'=> 1963, 'ranking' => null ],
...
['name'=>'Government Post Graduate College', 'city'=>'Solan', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gcsolan.ac.in', 'logo' => null, 'established_year'=> 1959, 'ranking' => null ],
...
['name'=>'Government Degree College', 'city'=>'Chamba', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gcchamba.edu.in', 'logo' => 'https://gcchamba.edu.in/wp-content/themes/college/images/logo.png', 'established_year'=> 1958, 'ranking' => null ],
['name'=>'Government Degree College', 'city'=>'Chowari, Chamba', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gcchowari.edu.in', 'logo' => null, 'established_year'=> 1994, 'ranking' => null ],
['name'=>'Government Degree College', 'city'=>'Bharmour, Chamba', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gcbharmour.com', 'logo' => null, 'established_year'=> null, 'ranking' => null ],
['name'=>'Government Degree College', 'city'=>'Telka, Chamba', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gdctelka.com', 'logo' => null, 'established_year'=> null, 'ranking' => null ],
...
['name'=>'Chaudhary Sarwan Kumar Himachal Pradesh Krishi Vishvavidyalaya (CSKHPKV), Palampur', 'city'=>'Kullu', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.hillagric.ac.in', 'logo' => 'https://www.hillagric.ac.in/images/university.gif', 'established_year'=> 1978, 'ranking' => null ],
...
['name'=>'Government Polytechnic College', 'city'=>'Kullu', 'type'=>'public', 'state'=>'Himachal Pradesh', 'website'=>'www.gpkullu.edu.in', 'logo' => 'https://www.gpkullu.edu.in/images/logo.png', 'established_year'=> null, 'ranking' => null ],
...
['name'=>'All India Institute of Medical Sciences (AIIMS)', 'city'=>'New Delhi', 'type'=>'public', 'state'=>'Delhi', 'website'=>'www.aiims.edu', 'logo' => 'https://www.aiims.edu/images/logo.png', 'established_year'=> 1956, 'ranking' => 1],
...
['name'=>'Hindu College', 'city'=>'New Delhi', 'type'=>'public', 'state'=>'Delhi', 'website'=>'www.hinducollege.ac.in', 'logo' => 'https://www.hinducollege.ac.in/images/logo.png', 'established_year'=> 1899, 'ranking' => 1],
['name'=>'St. Stephen\'s College', 'city'=>'New Delhi', 'type'=>'public', 'state'=>'Delhi', 'website'=>'www.ststephens.edu', 'logo' => 'https://www.ststephens.edu/wp-content/uploads/2019/07/st-stephens-college-logo.png', 'established_year'=> 1881, 'ranking' => 5],
...
['name'=>'Presidency College', 'city'=>'Chennai', 'type'=>'public', 'state'=>'Tamil Nadu', 'website'=>'www.presidencychennai.com', 'logo' => null, 'established_year'=> 1840, 'ranking' => 15],
['name'=>'Lady Shri Ram College for Women (LSR)', 'city'=>'New Delhi', 'type'=>'public', 'state'=>'Delhi', 'website'=>'www.lsr.edu.in', 'logo' => 'https://www.lsr.edu.in/images/logo.png', 'established_year'=> 1956, 'ranking' => 17],
['name'=>'Shri Ram College of Commerce (SRCC)', 'city'=>'New Delhi', 'type'=>'public', 'state'=>'Delhi', 'website'=>'www.srcc.edu', 'logo' => 'https://www.srcc.edu/sites/all/themes/srcc/logo.png', 'established_year'=> 1926, 'ranking' => 18],
['name'=>'Hansraj College', 'city'=>'New Delhi', 'type'=>'public', 'state'=>'Delhi', 'website'=>'www.hansrajcollege.ac.in', 'logo' => 'https://www.hansrajcollege.ac.in/images/logo.png', 'established_year'=> 1948, 'ranking' => 3],
...
foreach ($universities as $uni) {
    ...
    $universityIds[$uni['name']] = $universityId;
}
    }
}
